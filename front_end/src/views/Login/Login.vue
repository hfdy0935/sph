        ...
        <div class="loginform">
          ...
          <div class="content">
            <form action="##">
              ...
              <button class="btn" @click.prevent="loginEvent">登&nbsp;&nbsp;录</button>
            </form>
...
<script setup lang="ts" name="Login">
  ...
  async function loginEvent(){
    let data = {'tel': tel.value, 'password': password.value};
...
</style>@/stores/user@/router/user@/router/user@/stores/user