            ...
            <div class="title clearfix">
                ...
                <div class="fr">
                    <ul class="nav-tabs clearfix">
                        <li class="active" v-for="(item,index) of data.navList" :key="index">
            ...
            <div class="tab-content">
                <div class="tab-pane">
                    <div class="floor-1">
                        <div class="blockgary">
                            <ul class="jd-list">
                                <li v-for="(item,index) of data.keywords" :key="index">{{item}}</li>
                            </ul>
                            <img :src="data.imgUrl" />
                        </div>
                        <div class="floorBanner">
                            <Carousel :list="data.carouselList" :height="'360px'"></Carousel>
                        </div>
                        <div class="split">
